    ...
    return (
        <>
            <ScrollAnimation>
                ...
                <div className="container mx-auto px-8 mt-16 mb-32 ">
                    ...
                    <div className="grid lg:grid-cols-3 lg:gap-3">
                        <div className="flex flex-col justify-between w-full h-full me-4 font-bold text-xl transition-all duration-300">
                            <button
                                onClick={() => {
                                    setNumber(1)
                                }}
                                className={`tab-btn mb-4 ${N === 1 ? 'bg-sky-500 text-white' : 'bg-gray-50'} rounded-xl hover:ring-1 `}
                                type="button">
                            ...
                            <button
                                ...
                                className={`tab-btn mb-4 ${N === 2 ? 'bg-sky-500 text-white' : 'bg-gray-50'} rounded-xl hover:ring-1 transition-all duration-300`}
                                type="button">
                            ...
                            <button
                                ...
                                className={`tab-btn mb-4 ${N === 3 ? 'bg-sky-500 text-white' : 'bg-gray-50'} rounded-xl hover:ring-1 transition-all duration-300`}
                                type="button">
                            ...
                            <button
                                ...
                                className={`tab-btn mb-0 ${N === 4 ? 'bg-sky-500 text-white' : 'bg-gray-50'} rounded-xl hover:ring-1 transition-all duration-300`}
                                type="button">
                        ...
                        <div className="w-full md:mt-4  lg:col-span-2 lg:mt-0">
                            <div className="grid gap-3 md:grid-cols-2 ">
                                <Image className="w-full h-full mt-4  md:mt-0 rounded-xl" src={data[N - 1].logo}
                                ...
                                <div className="mt-6 flex flex-col justify-between md:mt-0 md:h-auto">
                                    ...
                                    <Link href={data[N - 1].link} target='_blank'
                                          className="flex-center text-white py-3 px-3 mt-5 bg-sky-500  rounded-xl hover:ring-1 transition-all duration-300 relative text-xl">Visit Page</Link>
                                </div>
                            </div>
                        </div>
                    </div>
